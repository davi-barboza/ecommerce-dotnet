    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            data.forEach(function (Entitie) {
                ...
                htmlConteudo += "</br><h3 id='" + idNome + "' > Produto: " + Entitie.nome + "</h3></br>";

                if (Entitie.url != null && Entitie.url != "" && Entitie.url != undefined) {

                    htmlConteudo += "<img width='200' height='210' src='" + Entitie.url + "'/></br>";
                }

                htmlConteudo += "<label> <strong> Valor: </strong>" + (Entitie.valor).duasCasas() + "</label></br>";
